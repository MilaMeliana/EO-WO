                ...
                <?php $__currentLoopData = $dataPaket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 mb-5">
                        <div class="member" data-aos="zoom-in" data-aos-delay="100">
                            <img src="<?php echo e(asset('storage/' . $d->logo)); ?>" class="img-fluid" alt="">
...
<?php echo $__env->make('landingpage.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Kelompok5_EO-WO\resources\views/landingpage/catalogpaket.blade.php ENDPATH**/ ?>